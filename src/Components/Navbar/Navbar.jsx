        ...
        <header>
            ...
            <nav>
                ...
                <Link className="nav-logo" to={"/home"}><img src="public/img/logo-navbar.png" alt="Logo Wine Experience" className="logo-nav" /></Link>
                    ...
                    <ul>
                        <li><Link to={"/PedidosCliente"}><img src="public/img/pedidos-navbar.png" alt="Pedidos" className="symbols-navbar"/></Link></li>
                        <li><Link to={"/CarrinhoDeCompras"}><img src="public/img/carrinho-navbar.png" alt="Carrinho" className="symbols-navbar"/></Link></li>
                        <li><Link to={"/Identificacao"}><img src="public/img/acount-navbar.png" alt="Minha conta" className="symbols-navbar" /></Link></li>
                    </ul>
                </div>
